...
// 对应官方测试：ref/01/And.tst / ref/01/And.cmp
module And_tb;
...
`endif
    ...
    b = 1'h1;
    #10;
    tst_check(a, 1'h0, b, 1'h1, out, 1'h0);
    step = step + 1;
    a = 1'h1;
    b = 1'h0;
    #10;
    tst_check(a, 1'h1, b, 1'h0, out, 1'h0);
    step = step + 1;
    a = 1'h1;
    b = 1'h1;
    #10;
    tst_check(a, 1'h1, b, 1'h1, out, 1'h1);
    step = step + 1;
