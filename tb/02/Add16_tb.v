...
// 对应官方测试：ref/02/Add16.tst / ref/02/Add16.cmp
module Add16_tb;
...
`endif
    ...
    b = 16'hffff;
    #10;
    tst_check(a, 16'h0, b, 16'hffff, out, 16'hffff);
    step = step + 1;
    a = 16'hffff;
    b = 16'hffff;
    #10;
    tst_check(a, 16'hffff, b, 16'hffff, out, 16'hfffe);
    step = step + 1;
    a = 16'haaaa;
    b = 16'h5555;
    #10;
    tst_check(a, 16'haaaa, b, 16'h5555, out, 16'hffff);
    step = step + 1;
    a = 16'h3cc3;
    b = 16'hff0;
    #10;
    tst_check(a, 16'h3cc3, b, 16'hff0, out, 16'h4cb3);
    step = step + 1;
    a = 16'h1234;
    b = 16'h9876;
    #10;
    tst_check(a, 16'h1234, b, 16'h9876, out, 16'haaaa);
    step = step + 1;
