        ...
        begin
            ...
            if (exp_ARegister_0 === {16{1'bx}}) begin
                ...
                if (ARegister_0 !== exp_ARegister_0) begin
                    $display("FAIL [step %0d] %s: got %h exp %h", step, "ARegister[0]", ARegister_0, exp_ARegister_0);
                    nfail = nfail + 1;
                end else begin
                    npass = npass + 1;
                end
            ...
            if (exp_DRegister_0 === {16{1'bx}}) begin
                ...
                if (DRegister_0 !== exp_DRegister_0) begin
                    $display("FAIL [step %0d] %s: got %h exp %h", step, "DRegister[0]", DRegister_0, exp_DRegister_0);
                    nfail = nfail + 1;
                end else begin
                    npass = npass + 1;
                end
